...
\vspace{1.5cm}
 % Isso na versao final do trabalho!!!       
   ...
   \ABNTEXchapterfont\assinatura{\textbf{Prof. Me. Claudio Ganança} \\ Universidade Municipal de São Caetano do Sul (USCS)}
   \ABNTEXchapterfont\assinatura{\textbf{Prof. Me. Mario Longato} \\ Universidade Municipal de São Caetano do Sul (USCS)}
   %\ABNTEXchapterfont\assinatura{\textbf{Professor 3} \\ Universidade Municipal de São Caetano do Sul (USCS)}
    \vfill
   \begin{center}
\vspace{0.5cm}
\imprimirlocal, 07 de dezembro de 2023 % Especificar data da defesa
    \vspace*{1cm}
  \end{center}
